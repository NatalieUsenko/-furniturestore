...
?>
    <div id="firstscreen">
        <div class="info">
            <img src="<?php echo get_template_directory_uri();?>/img/tmp-logo.png" style="margin-bottom: 50px;">
            <?php
        ...
        <div class="slider">
            ...
            <?php echo do_shortcode('[wpoc-owl-carousel category="4"  singleItem="true" items="1" navigation="true" pagination="true" lazyLoad="true" slideSpeed="900" paginationSpeed="400"]');?>
        </div>
        <div class="grey-line">
